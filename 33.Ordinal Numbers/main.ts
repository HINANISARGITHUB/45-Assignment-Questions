// Question #33: Ordinal Numbers: Ordinal numbers indicate their position in a array, such as 1st or 2nd. Most ordinal 
...
for(let i = 0; i < ordinalNumber.length; i++) {
    ...
    else if(ordinalNumber[i] >= 4 && ordinalNumber[i] <= 9) {
        console.log(`${ordinalNumber[i]}th`);
    }
    
    else{
        console.log("With loop to create ordinal number");
    }   
}
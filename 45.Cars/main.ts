...
function car (manufacture: string, model: number, ...rest: {[keyword: string]: any} []) {
   let car_Obj = {
...
let car1: string = car("Civics", 2022);
console.log(car1);

let car2: string = car("Toyota land crusier", 2024, {color: "Silver pearl"}, {Optional_feature: ["Fuel_Tank_Capacity","Seating Capacity"]});
console.log(car2);